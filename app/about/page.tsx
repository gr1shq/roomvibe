    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-purple-900 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <header className="max-w-3xl mx-auto text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-200 mb-4">
          Welcome to <span className="text-purple-400">RoomVibe</span>
        </h1>
        <p className="text-lg text-purple-300">
          Your digital corner for discovering aesthetic, cozy, and mood-setting room upgrades.
        </p>
      </header>
      ...
      <main className="max-w-2xl mx-auto bg-gray-800 rounded-xl shadow-2xl p-8 sm:p-10 border border-gray-700">
        ...
        <section className="mb-10">
          <p className="text-gray-300 text-lg leading-relaxed mb-6">
            We are a small but passionate team obsessed with turning everyday spaces into personal sanctuaries. 
            From LED lights that set the mood to minimalist desk setups and vibe-packed décor, we handpick 
            products that transform any room into your favorite place to be.
          </p>
          
          <p className="text-gray-300 text-lg leading-relaxed">
            Whether you are building your dream gaming setup, a study zone, or just want that perfect 
            sunset lamp glow — RoomVibe helps you find what <span className="italic text-purple-400">feels right</span>.
          </p>
        </section>
        ...
        <section className="space-y-4 mb-12">
          <div className="flex items-start">
            ...
            <p className="text-gray-300">Curated with love.</p>
          </div>
          <div className="flex items-start">
            <span className="text-2xl mr-3 text-purple-400">🔗</span>
            <p className="text-gray-300">Powered by affiliate magic.</p>
          </div>
          <div className="flex items-start">
            <span className="text-2xl mr-3 text-purple-400">✨</span>
            <p className="text-gray-300">Inspired by aesthetics, TikTok trends, and cozy late-night scrolling.</p>
          </div>
        </section>
